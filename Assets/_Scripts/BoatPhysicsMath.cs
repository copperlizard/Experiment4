...
namespace BoatSpace
{
    ...
    public static class BoatPhysicsMath
    {
        ...
        //Fluid
        public const float m_RHO_WATER = 1000f;
        public const float m_RHO_OCEAN_WATER = 1027f;
        public const float m_RHO_SUNFLOWER_OIL = 920f;
        public const float m_RHO_MILK = 1035f;
        //Gas
        public const float m_RHO_AIR = 1.225f;
        public const float m_RHO_HELIUM = 0.164f;
        //Solid
        public const float m_RHO_GOLD = 19300f;

        //Drag coefficients
        public const float m_C_d_flat_plate_perpendicular_to_flow = 1.28f;
