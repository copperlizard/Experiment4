...
namespace BoatSpace
{
    ...
    {
        //The boat transform needed to get the global position of a vertices
        ...
        //Find vertical projection distance between each vertex and water surcface 
        ...
        public void GenerateUnderwaterMesh()
        {
            ...
            for (int j = 0; j < m_boatVertices.Length; j++)
            {
                ...
                m_allDistancesToWater[j] = WaterController.current.DistanceToWater(globalPos, Time.time);
            }
        ...
        private void AddTrianglesOneAboveWater(List<VertexData> vertexData)
        {
            ...
            //because the resulting area will always form a 4 sided polygon
